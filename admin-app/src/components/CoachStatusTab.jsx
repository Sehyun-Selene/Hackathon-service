...
// 각 마스터 메이트가 쉬는 중인지 / 어떤 팀 호출을 대응 중인지 표시.
// 목적: 특정 마스터 메이트가 바쁘면(대응 중이면) 다른 마스터 메이트가 그 담당 팀 호출을 대신 볼 수 있게.
export default function CoachStatusTab({ scan, coach }) {
  ...
  // 이 기기 마스터 메이트의 이름이 COACH_ASSIGNMENTS 명단과 일치하면, 그 마스터 메이트가
  ...
  return (
    <div>
      <section className="panel">
        <h3>마스터 메이트 현황 ({scan.coaches.length}명)</h3>
      ...
      <p className="coach-note">
        💡 담당 마스터 메이트가 바쁘면(🔴), 그 마스터 메이트 담당 팀의 대기 호출을 다른 마스터 메이트가 대신 처리할 수 있습니다.
      </p>
    </div>
  )
}
