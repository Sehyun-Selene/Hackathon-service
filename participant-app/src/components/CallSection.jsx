...
export default function CallSection({ callData, callCount, onCall, teamButton = null }) {
  ...
  return (
    <section className="call-section">
      ...
      <div className={`call-hero${active ? ' active' : ''}${limitReached ? ' exhausted' : ''}`}>
        <LanternIcon state={active ? 'active' : 'idle'} size={68} />
        <h2>
          {active
